...
ActiveRecord::Schema.define(version: 20161127205158) do
  ...
  create_table "image_to_pdf_images", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["id", "image_to_pdf_document_id"], name: "index_image_to_pdf_images_on_id_and_image_to_pdf_document_id", using: :btree
